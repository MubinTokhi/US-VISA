...
from us_visa.utils.main_utils import load_numpy_array, load_object, read_yaml_file, save_object
from us_visa.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassficationMetricArtifact
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) ->Tuple[object,object]:
        ...
        try:
            ...
            metric_artifact = ClassficationMetricArtifact(f1_score=f1,recall_score=recall,precision_score=precision)
    ...
    def initaite_model_trainer(self) -> ModelTrainerArtifact:        
        ...
        On Failure  :   Write an exception log and then raise an exception
        """
        logging.info("Entered initaite_model_trainer method of ModelTrainer class")
        try:
